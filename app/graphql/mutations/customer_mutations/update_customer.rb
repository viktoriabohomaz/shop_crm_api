module Mutations
  module CustomerMutations
    class UpdateCustomer < BaseMutation
      ...
      def resolve(id:, first_name: nil, last_name: nil, photo: nil, created_by_id: nil, updated_by_id: nil)
        # Авторизация
        ...
        if customer&.update(
          ...
          { customer: nil, errors: customer ? customer.errors.full_messages : ['Customer not found'] }
        end
      end
    end
  end
